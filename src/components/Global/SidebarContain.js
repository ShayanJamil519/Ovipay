...
const SidebarContain = ({ menuToggle, setMenuToggle }) => {
    ...
    return (
        <div className="relative">
            ...
            >
                <div className="flex items-center w-full pl-7 sm:pl-10 text-lg h-[18vh] sm:h-[25vh]">
                    <img src={logo} alt="" />
                    <div>
                ...
                <div className="flex flex-col h-[82vh] sm:h-[75vh] pb-3  overflow-y-scroll bg-white ">
