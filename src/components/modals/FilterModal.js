            ...
            <Modal isOpen={isOpen} className="mx-3 rounded-xl">
                ...
                <ModalBody className="border-0">
                    ...
                    <div className="flex flex-wrap justify-center mt-2">
                        <Button className="bg-[#fed52a] text-black  rounded-xl border-1 border-gray-200 px-3 mr-2 my-2">
                            {" "}
                            테스트{" "}
                        </Button>
                        <Button className="px-3 mx-3 my-2 text-gray-400 bg-white border-gray-200 rounded-xl border-1">
                            {" "}
                            테스트{" "}
                        </Button>
                        <Button className="px-3 mx-2 my-2 text-gray-400 bg-white border-gray-200 rounded-xl border-1">
                            {" "}
                            테스트{" "}
                        </Button>
                    </div>
                    ...
                    <h1 className="font-bold text-[20px] mt-4 mb-3">
                        두번째 필터
                    </h1>

                    <div className="flex flex-wrap gap-x-3 gap-y-2">
                        <Button className="px-3 mx-2 mt-1 text-gray-400 bg-white border-gray-200 rounded-xl border-1">
                            이것도 테스트
                        </Button>
                        <Button className="bg-[#fed52a] text-black  rounded-xl border-1 border-gray-200 px-3 mx-2 mt-1">
                            테스트
                        </Button>
                        <Button className="px-3 mx-2 mt-1 text-gray-400 bg-white border-gray-200 rounded-xl border-1">
                            테스트
