                    ...
                    <div className="flex w-full justify-between items-center px-4">
                        <div className="flex gap-4 mt-3">
                            <p
                                className={`${
                                    selected === 0
                                        ? "text-[#464441] border-b-2 border-[#FED52a]"
                                        : "text-[#C3C3C3]"
                                }`}
                        ...
                        <p className="mt-3 text-[12px] text-[#818181]">
                            {"더보기 >"}
                        </p>
                    </div>
                            ...
                            >
                                ...
                                <div className="flex items-start flex-col justify-start w-full h-full">
                                    ...
                                    <p className="text-[18px] font-[900] mt-2">
                                        {product.price}{" "}
                                        <span className="font-[300]">원</span>
                                    </p>
                                </div>
                            </div>
                        ))}
