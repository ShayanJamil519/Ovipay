            ...
            <div className="flex flex-col items-center justify-center w-full ">
                <div className="flex items-center justify-between w-full px-3 mt-3">
                    ...
                    <IoIosArrowBack
                        onClick={handleBackClick}
                        size={25}
                        className="rotate-180 rounded-full cursor-pointer text-black/50"
                    />
                </div>

                <Link to="/gift-home" className="hover:no-underline ">
                    <div className="relative cursor-pointer top-48">
                        <ImSearch size={130} className="text-black/30" />
                        <p className="font-extrabold text-center text-black/30">
                            제품 검색...
                        </p>
                    </div>
                </Link>
