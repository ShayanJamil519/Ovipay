                ...
                <div className="w-[90%] border rounded-xl p-2 mb-4 shadow-md">
                    ...
                    <div className='flex flex-col items-center justify-center mb-6 w-full px-2 gap-2'>
                        <div className='flex justify-between w-full items-start font-[400]'>
                            <p className='text-[#8D8D8D]'>상품 가격</p>
                            <p>35,000 원</p>
                        </div>
                        <div className='flex justify-between w-full items-end font-[400]'>
                            <p className='text-[#8D8D8D]'>할인금액</p>
                            <p>0 원</p>
                        </div>
                        <div className='flex justify-between w-full items-end font-[400]'>
                            <p className='text-[#8D8D8D]'>배송비</p>
                            <p>3,000 원</p>
                        </div>
                        
                        <hr className='w-full h-[0.4px] bg-[#BABABA] my-2' />

                        <div className='flex justify-between w-full items-start font-[400]'>
                            <p className='text-[#8D8D8D]'>신용카드결제</p>
                            <p>35,000 원</p>
                        </div>
                    ...
                    <div className="w-[90%] mx-3 mt-8 mb-4">
                        <button
                            className="w-full bg-[#373535] text-white py-3 px-3 bottom-1 rounded-[50px] font-[700] text-[12px]"
                        >
                            교환, 반품 신청
                        </button>
                    </div>
